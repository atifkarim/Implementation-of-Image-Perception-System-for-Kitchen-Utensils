...
path_mask = 'F:/save_image_ai/object_subtraction_for_UE4/image_AI/1_mask_calgonit'
path_rgb = 'F:/save_image_ai/object_subtraction_for_UE4/image_AI/1_rgb_calgonit'
...
#        print('read_im: ',image_mask2)
        ...
        cv2.drawContours(image_mask2, contours, 0, (255,255,255), 3)
        cnt = contours[0]
